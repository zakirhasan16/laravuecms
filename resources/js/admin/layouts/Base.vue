<template>
    <div id="page-container" :class="classContainer">
        ...
        <!-- Page Overlay -->
        <div id="page-overlay" v-if="$store.state.layout.sideOverlay && $store.state.settings.pageOverlay"
             @click="() => $store.commit('sideOverlay', { mode: 'close' })"></div>
        <!-- END Page Overlay -->
...
<script>
    ...
    import BaseSidebar from './partials/Sidebar'
    import BaseSideOverlay from './partials/SideOverlay'
    import BaseFooter from './partials/Footer'
